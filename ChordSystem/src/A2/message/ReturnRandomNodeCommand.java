...
public class ReturnRandomNodeCommand implements Command {
	public static final String cmd = "CMD_ReturnRandomNodeCommand";

	public String ipAddress;
	public int port;
	public int id;

	public ReturnRandomNodeCommand() {
	}

	public ReturnRandomNodeCommand(String ipAddress, int port, int id) {
		super();
   ...
   public String toString() {
      return "ReturnRandomNodeCommand [cmd=" + cmd + ", ipAddress=" + ipAddress + ", port=" + port
            + ", id=" + id + "]";
   }	
